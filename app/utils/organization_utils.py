    ...
    try:
        ...
        try:
            ...
            try:
                ...
                logger.error(f"Error parsing summary JSON for organization {org_name}: {response}")
...
async def update_organization_summary(organization_id, summary_data):
    """
    Update an organization record with summary information.
    
    Args:
        organization_id (str): The ID of the organization to update
        summary_data (dict): The summary information generated
